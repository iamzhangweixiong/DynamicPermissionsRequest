 ...
 */
package com.zhangwx.dynamicpermissionsrequest.permission;
...
public class EasyPermissions {
     ...
     *
     * @see #requestPermissions(Fragment, int, String, String, int, int, int, String...)
     */
    ...
    public static void requestPermissions(@NonNull Fragment fragment,
        ...
        if (shouldShowRationale(fragment, perms)) {
            RationaleDialogFragmentCompat
                    .newInstance(positiveButton, negativeButton, icon, title, rationale, requestCode, perms)
     ...
     * Request a set of permissions, showing rationale if the system requests it.
     *
     * @see #requestPermissions(android.app.Fragment, int, String, String, int, int, int, String...)
     */
